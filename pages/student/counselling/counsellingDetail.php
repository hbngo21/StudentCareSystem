    ...
    <?php
        ...
        "</div></div></div></div>
                    <div class=\"row mt-5\">
                        <div class=\"col justify-content-center\">
                            <div class=\"card\" style=\"max-width: 35rem;\">
                                ...
                                <div class=\"card-body\">
                                    <div class=\"card-text\">
                                        Nhân viên: ". $row['MEDICAL_STAFFID'] . " <br>
                                        Thời gian phản hồi: ". date("d-m-Y H:i:s", strtotime($row['RESPONSE_TIMESTAMP']))."
                                        <br>Nội dung phản hồi:<br>". $row['RESPONSE_CONTENT']. "<br>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class=\"col-5 mt-5\">
                    <img class=\"align-middle\" src=\"../../../assets/images/responsed_counselling.svg\" alt=\"\" width=\"95%\">
                </div>
            </div>
        </div>
        </div>";
