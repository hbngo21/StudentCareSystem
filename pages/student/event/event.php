                        ...
                        <div class="row event__item animate__animated animate__fadeInLeft">
                            ...
                            <div class="col-md-9 p-2 d-flex flex-column justify-content-between">
                                ...
                                if (in_array($name, $registerevent))
                                    echo "<button type='button' class='btn event__register-btn' style='width: 100px;' disabled>Đã đăng ký</button>";
                                else {
                                    $param_func = "registerEvent('" . $name . "', " . $studentid . ")";
                                    echo "<button type='button' class='btn event__register-btn' style='width: 100px;' onclick=\"" . $param_func . "\"" . ">Đăng ký</button>";
                                }
                                ?>
                            </div>
                        </div>
