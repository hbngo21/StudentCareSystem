...
<body>
    ...
    <ol class="breadcrumb" id="breadcrumb">
      ...
      <li class="breadcrumb-item " aria-current="page"><a href="../schoolar/schoolar.php">Học bổng</a></li>
      <li class="breadcrumb-item active" aria-current="page">Chi tiết</li>
        ...
        <div class="row event__detail"style="margin-left:-0.1rem;margin-top:3rem">
            ...
            <div class="col-md-8 pt-2">
                ...
                <a href="schoolar.php" type='button' class='btn' style='width: 100px;margin-top:5rem'>Quay lại</a>
            </div>
        </div>
    </main>
