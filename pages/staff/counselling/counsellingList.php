        ...
        <div class="col-2">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">Yêu cầu chờ phản hồi</a></li>
                        <li><a class="dropdown-item" href="#">Yêu cầu đã giải quyết</a></li>
                    </ul>
                </div>
      </div>
      <?php
                ...
                if ($resultCheck > 0){
                  ...
                  >
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        ...
                        if (empty($row['MEDICAL_STAFFID']))
                            echo "<td style=\"text-align: center\"><a href=\"./response.php\"><button class=\"btn\">Phản hồi</button></a></td>";
