...
<body>
    ...
    <main>
        ...
        <div class="row event__detail" style="margin-left:-0.1rem;margin-top:0rem;">
            <div class="col-md-4 pt-2"><img src="https://media.istockphoto.com/vectors/book-logo-template-vector-id1256528848?b=1&k=20&m=1256528848&s=612x612&w=0&h=T9559DTJrWCW2aVrIpQgcxl515QitubN_Bikya3w27k=" class="img-fluid rounded b-shadow-a" width="100%" alt=""></div>
            <div class="col-md-8 pt-2">
                ...
                <div class="mt-2">
                    ...
                    <h2>
                        <span id="Chú_thích"></span><span class="mw-headline" id="Ch.C3.BA_th.C3.ADch">Chú thích</span>
                    </h2>
