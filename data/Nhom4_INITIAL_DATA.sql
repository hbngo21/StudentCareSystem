...
INSERT INTO `studentcare`.`jobscholarship_infor` (`ID`, `TITLE`, `CONTENT`, `ENTERPRISE`, `POLITICAL_STAFFID`) VALUES ('j1', 'job 1', 'content j1', 'fpt', '9866');
INSERT INTO `studentcare`.`jobscholarship_infor` (`ID`, `TITLE`, `CONTENT`, `ENTERPRISE`, `POLITICAL_STAFFID`) VALUES ('s2', 'scholarship 2', 'content s2', 'intel', '5670');
INSERT INTO `studentcare`.`jobscholarship_infor` (`ID`, `TITLE`, `CONTENT`, `ENTERPRISE`, `POLITICAL_STAFFID`) VALUES ('j2', 'job 2', 'content j2', 'vng', '9866');

 -- IncentiveScholarshipResult
INSERT INTO `studentcare`.`incentivescholarship_result` (`NAME`, `INFORMATION`, `SEMESTERCODE`, `TRAININGDEPARTMENT_STAFFID`) VALUES ('scholarship201', 'information201', '201', '7383');
INSERT INTO `studentcare`.`incentivescholarship_result` (`NAME`, `INFORMATION`, `SEMESTERCODE`, `TRAININGDEPARTMENT_STAFFID`) VALUES ('scholarship202', 'information202', '202', '5371');
INSERT INTO `studentcare`.`incentivescholarship_result` (`NAME`, `INFORMATION`, `SEMESTERCODE`, `TRAININGDEPARTMENT_STAFFID`) VALUES ('scholarship203', 'information203', '203', '7006');
